...
<div class="card">
    <div class="card-body">
        ...
        <div class="alert alert-danger">
            <p>Anda belum mengajukan Pendaftaran Ujian Tugas Akhir</p>
        </div>
    </div>
</div>
@else
...
<div class="card">
    <div class="card-body">
        ...
        <div class="card">
            ...
            @if ($final_exam->status_kelengkapan_dokumen == 'belum lengkap')
            <div class="alert alert-danger">
                Silahkan lengkapi dokumen dibawah ini
            </div>
            <table class="table table-bordered">
                ...
                <tr>
                    <td>File Skripsi</td>
                    <td>:</td>
                    <td>@if ($final_exam->file_1)
                        <a href="{{ asset('storage/final_exam/' . $final_exam->file_1) }}" target="_blank">File Skripsi</a>
                    @else
                        <form action="{{ route('user.uploadFile1') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <input type="file" name="file_1" id="file_1" class="form-control" required accept="application/pdf">
                            <input type="hidden" name="id" value="{{ $final_exam->id }}">
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>@if ($final_exam->file_2)
                        <a href="{{ asset('storage/final_exam/' . $final_exam->file_2) }}" target="_blank">Surat Keterangan Persetujuan Tugas Akhir</a>
                    @else
                        <form action="{{ route('user.uploadFile2') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <input type="file" name="file_2" id="file_2" class="form-control" required accept="application/pdf">
                            <input type="hidden" name="id" value="{{ $final_exam->id }}">
                            <button type="submit" class="btn btn-primary">Upload</button>
                        </form>
                    @endif</td>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>@if ($final_exam->file_3)
                        <a href="{{ asset('storage/final_exam/' . $final_exam->file_3) }}" target="_blank">Kartu Kehadiran Ujian Proposal Tugas Akhir</a>
                    @else
                        <form action="{{ route('user.uploadFile3') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <input type="file" name="file_3" id="file_3" class="form-control" required accept="application/pdf">
                            <input type="hidden" name="id" value="{{ $final_exam->id }}">
                            <button type="submit" class="btn btn-primary">Upload</button>
                        </form>
                    @endif</td>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>@if ($final_exam->file_4)
                        <a href="{{ asset('storage/final_exam/' . $final_exam->file_4) }}" target="_blank">Logbook Kegiatan Tugas Akhir</a>
                    @else
                        <form action="{{ route('user.uploadFile4') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <input type="file" name="file_4" id="file_4" class="form-control" required accept="application/pdf">
                            <input type="hidden" name="id" value="{{ $final_exam->id }}">
                            <button type="submit" class="btn btn-primary">Upload</button>
                        </form>
                    @endif</td>
        ...
        <div class="modal-content">
            <form action="{{ route('user.examPost') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        <label for="dosen_pembimbing1">Dosen Pembimbing 1 <span class="text-danger">*</span></label>
                        <input type="text" name="pembimbing_1" id="pembimbing_1" class="form-control" required
                            placeholder="Masukkan Nama Dosen Pembimbing 1 Lengkap beserta gelar"
                            value="{{ $proposal->pembimbing1 }}">
                    </div>
                    <div class="form-group mb-3">
                        <label for="dosen_pembimbing2">Dosen Pembimbing 2 <span class="text-danger">*</span></label>
                        <input type="text" name="pembimbing_2" id="pembimbing_2" class="form-control" required
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="penguji_1" id="penguji_1" class="form-control" required
                            placeholder="Masukkan Nama Penguji 1 Lengkap beserta gelar" value="{{ $jadwal->dosen1 }}">
                    </div>
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="penguji_2" id="penguji_2" class="form-control" required
                            placeholder="Masukkan Nama Penguji 2 Lengkap beserta gelar" value="{{ $jadwal->dosen2 }}">
                    </div>
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="penguji_3" id="penguji_3" class="form-control" required
                            placeholder="Masukkan Nama Penguji 3 Lengkap beserta gelar" value="{{ $jadwal->dosen3 }}">
                    </div>
                    {{-- <div class="form-group mb-3">
                    ...
                    <div class="form-group mb-3">
                        <label for="file_4">Logbook Kegiatan Tugas Akhir <span class="text-danger">*</span></label>
