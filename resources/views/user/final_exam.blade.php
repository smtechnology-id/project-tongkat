...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            @if ($final_exams->count() < 1)
                <p>Silahkan isi form dibawah ini untuk melakukan pendaftaran ujian tugas akhir</p>
            ...
            @if ($final_exam->status == 'approved')
                @if ($jadwal_exam == null)
                    <div class="card bg-warning">
                        <div class="card-body">
                            <p class="card-text">Jadwal Ujian Tugas Akhir Belum Ditentukan, Silahkan Menunggu Jadwal Dari Admin</p>
                        </div>
                    </div>
                @else
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>{{ $jadwal_exam->finalExam->pembimbing_1 }} (Dosen Pembimbing 1), {{ $jadwal_exam->finalExam->pembimbing_2 }} (Dosen Pembimbing 2)</td>
                                </tr>
                                <tr>
                                    <td>Penguji</td>
                                    <td>:</td>
                                    <td>{{ $jadwal_exam->finalExam->penguji_1 }} (Penguji 1), {{ $jadwal_exam->finalExam->penguji_2 }} (Penguji 2), {{ $jadwal_exam->finalExam->penguji_3 }} (Penguji 3)</td>
                                </tr>
                                <tr>
                                    <td>Waktu Ujian</td>
                                    <td>:</td>
