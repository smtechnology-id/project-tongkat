...
<div class="card">
    <div class="card-body">
        ...
        @if ($proposals->count() < 1) <p class="card-text">Silahkan isi form dibawah ini untuk mengajukan proposal
            skripsi</p>
            ...
            <div class="card">
                <div class="card-body">
                    <p class="card-text">Anda Dinyatakan <span class="text-success fw-bold"
                            style="font-size: 1.2rem">LULUS</span> Ujian Proposal, Silahkan lanjutkan ke tahap
                        selanjutnya di menu
                        <a href="{{ route('user.final_exam') }}">Ujian Tugas Akhir</a>
                    </p>
                </div>
            </div>
            @elseif ($proposal->status_kelulusan == 'tidak lulus')
            ...
            <div class="card bg-warning">
                <div class="card-body">
                    <p class="card-text">Proposal Anda Telah Disetujui Oleh Admin, Silahkan menunggu Jadwal Seminar
                        Proposal</p>
                </div>
            </div>
            @endif
                        ...
                        <form action="{{ route('user.proposalPost') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="catatan_mahasiswa" id="catatan_mahasiswa" class="form-control"
                ...
                <table class="table table-bordered" id="datatable1" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>@if ($proposal->status_kelulusan == 'pending')
                                <span class="badge bg-warning">Belum Diketahui</span>
                                @elseif ($proposal->status_kelulusan == 'lulus')
